...
Install alongside Cronchy's DeathHeadHopper 2.1.8 and the RepoXR dependencies to enjoy the VR experience.

## Quick note
Treat it like an alpha prototype :)
it could glitches so in case just call it a feature and keep hopping xD

## Credits
Thanks to Cronchy for creating the original *Death Head Hopper*.  
Original mod: https://thunderstore.io/c/repo/p/Cronchy/DeathHeadHopper/

Thanks to DaXcess for RepoXR, the VR compatibility layer this bridge relies on.  
RepoXR: https://thunderstore.io/c/repo/p/DaXcess/RepoXR/
